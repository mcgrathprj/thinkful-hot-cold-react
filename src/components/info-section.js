...
export default function InfoSection(props) {
  return (
    <section id="what" tabIndex="-1">
      ...
      <p>If you are using a screen reader, you can use the visually hidden "Hear state of game" link in the navigation region to get a reminder of all your past guesses and how close your current guess is to being correct.</p>
    </section>
  );
}
